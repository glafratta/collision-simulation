...
A probabilistic transition system is built when exact situations (identified by disturbances only) are encountered repeatedly. Default task are split into fixed-size chunks to simplify planning. 
