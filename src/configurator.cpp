...
//			g[*vIt].endPose-=deltaPose;
			...
			g[*vIt].endPose.p.x=task_distance*cos(g[*vIt].endPose.q.GetAngle())+ ydistance;
			g[*vIt].endPose.p.y=task_distance*sin(g[*vIt].endPose.q.GetAngle())-xdistance;
			if (g[*vIt].disturbance.getAffIndex()!=NONE){
				...
				float d_x= d_distance*cos(g[*vIt].disturbance.pose().q.GetAngle())+ydistance;
				float d_y= d_distance*sin(g[*vIt].disturbance.pose().q.GetAngle())-xdistance;
