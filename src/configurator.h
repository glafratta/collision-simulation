...
bool pruneTarget(std::vector<vertexDescriptor>, CollisionGraph&, vertexDescriptor&); // deletes queued vertices, changes v if it will be afected by the deletion and returns a break signal
